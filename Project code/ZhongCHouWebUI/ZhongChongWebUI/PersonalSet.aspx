        ...
        <div id="shebody">
            ...
            <div id="had_lb">
                <ul>
                    ...
                    <li><a href="#usersase">收件地址管理</a></li>
      ...
      <%--修改头像--%>
                    ...
                    <div id="usersase">
                        <div class="daers">
                            ...
                            <asp:Button ID="Button4" runat="server" Style="margin-left: 80px;" Text="保存" OnClick="Unnamed2_Click" BackColor="#F45F5B" BorderStyle="Outset" ForeColor="White" Height="35px" Width="65px" />
                        </div>
                    </div>
                    <%--我的优惠--%>
                    <div id="usersgos">
